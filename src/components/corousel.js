          ...
          <div className="post-info text-center">
            <div className="bg-white m-auto position-relative post-header z-1 pb-0">
              ...
              <h5 className="post-title fw-semibold fs-19 mb-3">
                <Link href="/">
                  Guiding the Golden Years: A Realtor's Role in Senior-Focused
                  Real Estate
                </Link>
              </h5>
              {/* /.End Post Title */}
        ...
        <div className="post grid-post">
          ...
          <div className="post-info text-center">
            <div className="bg-white m-auto position-relative post-header z-1 pb-0">
              ...
              <h5 className="post-title fw-semibold fs-19 mb-3">
                <Link href="/">
                  Navigating Transitions: Real Estate Agents Dedicated to Senior
                  Living
                </Link>
              </h5>
              {/* /.End Post Title */}
          ...
          <div className="post-info text-center">
            <div className="bg-white m-auto position-relative post-header z-1 pb-0">
              ...
              <h5 className="post-title fw-semibold fs-17 mb-3">
                <Link href="/">
                  Home Matters: Tailored Real Estate Services for Seniors and
                  Their Unique Needs
                </Link>
              </h5>
              {/* /.End Post Title */}
        ...
        <div className="post grid-post" data-aos="fade" data-aos-delay={600}>
          ...
          <div className="post-info text-center">
            <div className="bg-white m-auto position-relative post-header z-1 pb-0">
              ...
              <h5 className="post-title fw-semibold fs-17 mb-3">
                <Link href="/">
                  Seniors First: Real Estate Agents Committed to Elevating
                  Retirement Living
                </Link>
              </h5>
              {/* /.End Post Title */}
