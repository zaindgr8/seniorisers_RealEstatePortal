      ...
      <>
          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-md-4 col-lg-3 col-xl-4">
                ...
                <h1 className="text-xl lg:text-3xl text-white font-bold ">Seniorisers</h1>
              </div>
              <div className="col-md-8 col-lg-9 col-xl-8 d-none d-md-block">
                <div className="d-flex justify-content-end">
                  <div className="d-flex align-items-center help-info">
                    ...
                    {/* <div className="flex-grow-1 ms-3">
                      ...
                      <p className="sub-text mb-0 fs-14">
                        Saturday and Sunday -{" "}
                        <span className="fw-semibold text-warning">CLOSED</span>
                      </p>
                    </div> */}
                  </div>
                  ...
                  {/* <div className="d-flex align-items-center help-info ms-4">
                    <div className="flex-shrink-0 icon">
                      <i className="fa-solid fa-map fs-30 text-white opacity-75"></i>
                    </div>
                    <div className="flex-grow-1 ms-3">
                      <h6 className="fs-15 fw-semibold help-info__title mb-0 text-white">
                        41st Avenue
                      </h6>
                      <p className="sub-text mb-0 fs-14">Las Vegas</p>
                    </div>
                  </div> */}
                </div>
              </div>
        ...
        >
          <div className="container-lg nav-container position-relative">
            <nav className="custom-navbar navbar navbar-expand-lg flex justify-between">
              {/* Start Navbar Brand */}
              <Link
                className="border-end navbar-brand pe-3 pe-sm-4 py-0"
                href="/"
              >
                <img className="logo-dark" src="assets/img/home.png" alt="" />
                <img className="logo-white" src="assets/img/home.png" alt="" />
              </Link>
              {/* End Navbar Brand */}
