                ...
                <div className="col-md-10 offset-md-1">
                  ...
                  <div className="section-header text-center mb-5">
                    ...
                    <div className="sub-title fs-16">
                      ...
                      <br />
                      seeking service providers to help address their real
                      estate inquiries.
                    </div>
                          ...
                          <div className="d-flex flex-column h-100">
                            <div className="mb-4">
                              ...
                              <h6 className="fs-23 mb-2">
                                Washington DC, St Avenue{" "}
                              </h6>
                              {/* /.End Property Name */}
                              <div className="fs-16">
                                <i className="fa-solid fa-location-dot" />
                                <span>Across United States of America</span>
                              </div>
                              {/* Start Property Description */}
                              <div className="mt-3">
                                Reach out to the community service center today
                                and submit your application as a service
                                provider.
                              </div>
